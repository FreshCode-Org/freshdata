...
<!-- cleanbench:begin (generated by benchmarks.cleanbench, do not edit) -->

# CleanBench full-suite results

Generated: 2026-07-04T17:07:31+00:00
Tracks: T1, T2, T3, T4, T5 | trained calib-v1 used: yes
...
| false_modification_rate | 0.0000 |
| false_modification_rate_without_profile | 0.0667 |
...
|---|---|
| rows | 50000 |
| speed_rows_per_sec | 127671.9000 |
| seconds_default | 0.3916 |
| seconds_with_semantic | 0.5117 |
| semantic_overhead_ratio | 0.3067 |
| peak_rss_bytes | 158859264 |
| peak_rss_delta_bytes | 23871488 |
| peak_rss_delta_semantic_bytes | 212992 |
| protected_column_violation_rate | 0.0000 |
| false_modification_rate | — |
| runtime_slowdown_vs_baseline | -0.0058 |
| memory_overhead_vs_baseline | 0.0083 |
